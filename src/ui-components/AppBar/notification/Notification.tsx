  ...
  return (
    <div className="relative">
      <div
        ...
        className="p-4 bg-gray-100 rounded-full cursor-pointer"
      >
        <span>
          <svg
            width="15"
      ...
      {showNotification && (
        <div className="flex items-center justify-center [&amp;>div]:w-full absolute z-10 top-16 left-[-200px]">
          <div className="rounded-xl border bg-card text-card-foreground shadow w-[300px]">
